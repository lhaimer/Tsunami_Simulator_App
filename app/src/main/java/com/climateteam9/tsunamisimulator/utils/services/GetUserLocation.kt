                ...
                fusedLocationProviderClient.lastLocation.addOnCompleteListener { task->
                    ...
                    if(location == null){
                       ...
                       // Log.d("Debug:" ,"Your Location:"+ location.altitude)
                        textLocation.setText(getCityName(location.latitude,location.longitude)[1])
                        textCity.setText(getCityName(location.latitude,location.longitude)[0])
                        textCost.setText("${location.latitude},${location.longitude}")
