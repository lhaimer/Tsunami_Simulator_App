...
public final class NavHeaderDrawerBinding implements ViewBinding {
  ...
  private NavHeaderDrawerBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static NavHeaderDrawerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderDrawerBinding((LinearLayout) rootView, imageView, textView);
    }
