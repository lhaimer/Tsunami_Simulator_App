//Requires JDK 12 in library for execution
package tsunamiriskcalculator;
...
//Main method to be called and instantiated for Tsunami risk calculation
    public static void main(String[] args) {
                try {
            TsunamiRiskCalculatorConstructor T = new TsunamiRiskCalculatorConstructor(1200,5,false);
